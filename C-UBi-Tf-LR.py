...
#
#            0     0.8329    0.8329    0.8329      1197
#            1     0.8329    0.8329    0.8329      1197
#
#     accuracy                         0.8329      2394
#    macro avg     0.8329    0.8329    0.8329      2394
# weighted avg     0.8329    0.8329    0.8329      2394
        ...
        with codecs.open('plain/ctrip_hotel_neg.utf8', 'r', encoding='utf8') as fn:
            with codecs.open('plain/ctrip_hotel_pos_group.utf8', 'r', encoding='utf8') as fpg:
                with codecs.open('plain/ctrip_hotel_neg_group.utf8', 'r', encoding='utf8') as fng:
                    with codecs.open('model/ctrip_hotel_CRF-UBi-Tf-LR_split.utf8', 'w', encoding='utf8') as fs:
