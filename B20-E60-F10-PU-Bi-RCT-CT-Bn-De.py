...
#
#            P     0.7978    0.6393    0.7098       463
#            N     0.7978    0.8978    0.8449       734
#
#     accuracy                         0.7978      1197
#    macro avg     0.7978    0.7686    0.7774      1197
# weighted avg     0.7978    0.7978    0.7926      1197
...
if MODE==2:
    ...
    with codecs.open('model/f10/ctrip_train_crffeatures.pkl', 'rb') as fx:
        with codecs.open('model/f10/ctrip_train_crfstates.pkl', 'rb') as fy:
            with codecs.open('model/f10/ctrip_train_%s_model.pkl' %modelfile, 'wb') as fm:
                bx = fx.read()
                by = fy.read()
                X = pickle.loads(bx)
                y = pickle.loads(by)
